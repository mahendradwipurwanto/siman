                    ...
                    <div class="row">
                    	<div class="col-lg-12">
                    		<div class="card">
                    			<div class="card-body">
                    				<h4 class="card-title mb-4">Edit data pengurus
                    				</h4>
                    			</div>
                    		</div>
                    	</div>
                    	...
                    	<div class="col-12">
                    		<div class="card">
                    			<div class="card-body">
                    				...
                    				<form
                    					action="<?php echo site_url('admin/edit_aksipengurus/'.$pengurus->id_pengurus);?>"
                    					method="post">
                    					<div class="form-group row">
                    						<label for="example-text-input" class="col-md-2 col-form-label">Nama Lengkap</label>
                    						<div class="col-md-10">
                    							<input class="form-control" type="text" id="example-text-input"
                    								name="nama_lengkap" value="<?php echo $pengurus->nama_lengkap;?>">
                    						</div>
                    					</div>
                    					<div class="form-group row">
                    						<label for="example-text-input"
                    							class="col-md-2 col-form-label">Jabatan</label>
                    						<div class="col-md-10">
                    							<input class="form-control" type="text" id="example-text-input"
                    								name="jabatan" value="<?php echo $pengurus->jabatan;?>">
                    						</div>
                    					</div>
