...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="page-title mb-0 font-size-18"> Presensi Jemaat <?php if (!empty($filter)) {
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
            <center><span style="font-size: 32px; font-family: arial">Laporan Presensi Jemaat</span></center>	
