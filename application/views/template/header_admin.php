				...
				<div class="h-100">
					...
					<div class="user-wid text-center py-4">
						...
						<div class="mt-3">
							...
							<p class="text-body mt-1 mb-0 font-size-13">ANTIOKHIA</p>
						...
						<ul class="metismenu list-unstyled" id="side-menu">
							...
							<li>
								...
								<ul class="sub-menu" aria-expanded="false">
									<li><a href="<?php echo site_url('admin/warta')?>">Warta</a></li>
									<li><a href="<?php echo site_url('admin/visitasi')?>">Visitasi</a></li>
								</ul>
							</li>
							...
							<li>
								...
								<ul class="sub-menu" aria-expanded="false">
									<li><a href="<?php echo site_url('admin/data_mingguan')?>">Data Mingguan</a></li>
									<li><a href="<?php echo site_url('presensi/atur_absen')?>">Atur Presensi</a></li>
									<li><a href="<?php echo site_url('presensi/rekap')?>">Rekap Presensi</a></li>
								</ul>
							</li>
							...
							<li>
								...
								<ul class="sub-menu" aria-expanded="false">
									<li><a href="<?php echo site_url('admin/data_jemaat');?>">Data Jemaat</a></li>
									<li><a href="<?php echo site_url('admin/data_pengurus')?>">Data Pengurus</a></li>
								</ul>
							</li>
							...
							<a href="javascript: void(0);" class="waves-effect">
								...
								<ul class="sub-menu" aria-expanded="false">
									<li><a href="<?php echo site_url('admin/baptis_admin')?>">Daftar Baptis</a></li>
									<li><a href="<?php echo site_url('admin/verifikasi_baptis')?>">Verifikasi</a></li>
								</ul>
							</li>
							...
							<a href="javascript: void(0);" class="waves-effect">
								...
								<ul class="sub-menu" aria-expanded="false">
									<li><a href="<?php echo site_url('admin/perjamuan_admin')?>">Data Daftar Perjamuan</a></li>
									<li><a href="<?php echo site_url('admin/jadwal_perjamuan_admin')?>">Atur Jadwal Perjamuan</a></li>
									<li><a href="<?php echo site_url('admin/verifikasi_perjamuan')?>">Verifikasi</a></li>
									<li><a href="<?php echo site_url('admin/laporan_perjamuan_admin')?>">Laporan Perjamuan</a></li>
								</ul>
							</li>
